...
This assessment is based on generating an unedited output from a typical {a11ytables} workflow: a `create_a11ytable()` passed to `create_a11y_wb()` and then written with `openxlsx::saveWorkbook()`.

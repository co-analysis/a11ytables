...
The page shosw how the features of the {a11ytables} package meet the GSS Best Practice and Impact Division's ['Making spreadsheets accessible: checklist of the basics'](https://gss.civilservice.gov.uk/policy-store/making-spreadsheets-accessible-a-brief-checklist-of-the-basics/), with features marked as essential or not.
...
There are several values used in the 'status' column of these tables:
...
Please add [an issue](https://github.com/co-analysis/a11ytables/issues) to the package's GitHub repository if you have any ideas for missing features, or provide a solution in [a pull request](https://github.com/co-analysis/a11ytables/pulls).
